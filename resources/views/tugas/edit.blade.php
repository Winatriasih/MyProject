...
<div class="container py-5" style="max-width: 800px;">
    <h2 class="text-center text-primary fw-bold mb-4">Edit Tugas</h2>
        ...
        <div class="card-body">
            <form action="{{ route('tugas.update', $tugas) }}" method="POST">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" name="judul" class="form-control rounded-3" value="{{ $tugas->judul }}" required>
                </div>
                ...
                <div class="mb-4">
                    ...
                    <input type="date" name="deadline" class="form-control rounded-3" value="{{ $tugas->deadline }}">
                </div>
...
@push('styles')
<!-- Tambahan untuk font dan tampilan -->
